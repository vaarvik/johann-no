          ...
          <div className="flex flex-col gap-4 md:gap-6">
            <div className="flex-1 text-center md:text-left">
              ...
              <Paragraph className="text-slate-300">
                We collect anonymous data, such as page views and clicks, to help improve the website. We will store one cookie to remember your consent. Analytics cookies are only set if you accept. <Link href="/privacy" className="text-blue-300 hover:text-white transition-colors duration-200">Read privacy policy.</Link>
              </Paragraph>
            </div>
