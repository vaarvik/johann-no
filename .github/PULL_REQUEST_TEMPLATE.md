...
-   [ ] CSS adhere to the conventions outlined in [README.md](/README.md#general-conventions).<details>
  ...
  <ul>
    ...
    <li>Implement CSS modules for component-specific styles.</li>
    <li>Carefully consider any modifications to global CSS files located in <code>app/lib/assets/css</code>.</li>
  </ul>
</details>
